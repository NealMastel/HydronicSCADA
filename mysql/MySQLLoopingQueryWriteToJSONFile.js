...
var con = mysql.createConnection({
  ...
  database: 'currenttemp'
    ...
    function intervalChartQueryFunc() {
      connection = "SELECT thermocouple, temperature, UNIX_TIMESTAMP(timestamp) FROM `charttemps` WHERE thermocouple BETWEEN 1 AND 5 ORDER BY timestamp DESC, thermocouple ASC LIMIT 100";

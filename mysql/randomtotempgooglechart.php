...
$sql1 = "INSERT INTO `charttemps` (`ID`, `thermocouple`, `temperature`, `timestamp`) VALUES (NULL, '1', ROUND((1850 + rand() * 30)/10,1), CURRENT_TIMESTAMP)";		// M250Supply1WaterTemp
$sql2 = "INSERT INTO `charttemps` (`ID`, `thermocouple`, `temperature`, `timestamp`) VALUES (NULL, '2', ROUND((1680 + rand() * 30)/10,1), CURRENT_TIMESTAMP)";	// M250Supply2WaterTemp
$sql3 = "INSERT INTO `charttemps` (`ID`, `thermocouple`, `temperature`, `timestamp`) VALUES (NULL, '3', ROUND((720 + rand() * 20)/10,1), CURRENT_TIMESTAMP)";		// M250Return1WaterTemp
